...
export function flattenFile(file: Resource): FlattenedFile {
  return {
    ...
    package_data_primary_language: getValues(
      file.package_data,
      "primary_language"
    ),
    ...
    package_data_download_checksums: getValues(
      file.package_data,
      "download_checksums"
    ),
    package_data_bug_tracking_url: getValues(
      file.package_data,
      "bug_tracking_url"
    ),
    ...
    package_data_extracted_license_statement: getValues(
      file.package_data,
      "extracted_license_statement"
    ),
    package_data_declared_license_expression: getValues(
      file.package_data,
      "declared_license_expression"
    ),
    package_data_declared_license_expression_spdx: getValues(
      file.package_data,
    ...
    package_data_related_packages: getValues(
      file.package_data,
      "related_packages"
    ),
  };
