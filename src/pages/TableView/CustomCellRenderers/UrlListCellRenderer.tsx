...
const UrlListCellRenderer: FunctionComponent<UrlListCellRendererProps> = (
  ...
  const {
    ...
    value,
    customUrlField,
    customUrlFieldFallback,
    customDisplayTextField,
    customDisplayTextFieldFallback,
    routerLink,
    urlPrefix,
  } = props;
              ...
              subValue.map((value, j) => (
                <span key={j}>
                  <LinkComponent
                    ...
                    value={
                      data[customUrlField]
                        ? data[customUrlField][i]
                          ? data[customUrlField][i][j]
                          : ""
                        : data[customUrlFieldFallback]
                        ? data[customUrlFieldFallback][i]
                          ? data[customUrlFieldFallback][i][j]
                          : ""
                        : value
                    }
                    customDisplayText={
                      data[customDisplayTextField]
                        ? data[customDisplayTextField][i]
                          ? data[customDisplayTextFieldFallback][i][j]
                          : ""
                        : data[customDisplayTextFieldFallback]
                        ? data[customDisplayTextFieldFallback][i]
                          ? data[customDisplayTextFieldFallback][i][j]
                          : ""
                        : value
                    }
