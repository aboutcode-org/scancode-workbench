...
export const FileTreeSamples: {
  ...
  {
    jsonFileName: "onlyFindings.json",
    flatData: [
      {
        id: 0,
        name: null,
        parent: "samples/JGroups/licenses",
                ...
                children: [
                  {
                    id: 0,
                    isLeaf: true,
                    key: "samples/JGroups/licenses/apache-1.1.txt",
                    name: null,
                    parent: "samples/JGroups/licenses",
                    path: "samples/JGroups/licenses/apache-1.1.txt",
                    title: "apache-1.1.txt",
                    type: "file",
                  },
                ],
                id: 4,
                ...
                children: [
                  {
                    id: 1,
                    isLeaf: true,
                    key: "samples/JGroups/src/FixedMembershipToken.java",
                    name: null,
                    parent: "samples/JGroups/src",
                    path: "samples/JGroups/src/FixedMembershipToken.java",
                    title: "FixedMembershipToken.java",
                    type: "file",
                  },
                  {
                    id: 2,
                    isLeaf: true,
                    key: "samples/JGroups/src/S3_PING.java",
                    name: null,
                    parent: "samples/JGroups/src",
                    path: "samples/JGroups/src/S3_PING.java",
                    title: "S3_PING.java",
